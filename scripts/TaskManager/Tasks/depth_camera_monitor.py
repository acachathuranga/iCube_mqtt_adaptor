...
class DepthCameraMonitor:
    ...
    def __init__(self):
        ...
        rospy.Subscriber(self.front_depth_cam_point_cloud_topic, PointCloud2, self.front_depth_cam_callback)
        rospy.Subscriber(self.rear_depth_cam_point_cloud_topic, PointCloud2, self.rear_depth_cam_callback)
...
if __name__ == "__main__":
    ...
    tassk = DepthCameraMonitor(comInterface=comInterface)
